		...
		if(!empty($result)){
			...
			if($result['payment_status'] == "Completed"){
				...
				if(!empty($user)){
					...
					if(isset($package_new->permission)){
						$package_new_detail     = json_decode($package_new->permission);
						$data = array(
							"package_id"      		=> $package_id,
							"maximum_account"       => $package_new_detail->maximum_account,
							"maximum_groups"        => $package_new_detail->maximum_groups,
							"maximum_pages"         => $package_new_detail->maximum_pages,
							"maximum_friends"       => $package_new_detail->maximum_friends,
							"expiration_date" 		=> $expiration_date
						);
					}else{
						$data = array(
